...
const slides = [
  {
    ...
    image: "/sleep-apnea-testing-at-home.jpg",
  },
  {
    id: "B",
    ...
    description:
      "Canada-wide home sleep testing and virtual treatment—no lab waitlists. Clinician-led, simple, and fast.",
    image: "/home-sleep-test-device.jpg",
  },
  {
    id: "C",
    ...
    description:
      "Canada-wide home sleep testing and virtual treatment—no lab waitlists. Clinician-led, simple, and fast.",
    image: "/sleep-wellness-recovery.jpg",
  },
]
    ...
    <div className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="relative w-full h-full">
        {slides.map((s, index) => (
          ...
          >
            <img src={s.image || "/placeholder.svg"} alt={s.heading} className="w-full h-full object-cover" />
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-4 md:px-8">
        <div className="max-w-2xl space-y-6 animate-fade-in-up">
          <div className="inline-block px-4 py-2 bg-primary/20 rounded-full border border-primary/40 mb-4">
            <span className="text-sm font-medium text-primary">Option {slide.id}</span>
          </div>
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-balance">{slide.heading}</h1>
          <p className="text-xl md:text-2xl font-semibold text-secondary">{slide.subheading}</p>
      ...
      <div className="absolute bottom-8 right-8 z-10 text-right">
        <div className="relative">
          ...
          <div className="relative px-4 py-2 border border-primary/40 rounded-lg bg-black/30 backdrop-blur-sm">
            <p className="text-xs md:text-sm font-medium text-primary/90 tracking-wide uppercase">Serving</p>
