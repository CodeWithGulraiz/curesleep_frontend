...
export default function CTASection() {
  ...
  return (
    <section className="px-4 py-20 md:px-8 bg-gradient-to-br from-primary/75 to-secondary/75">
      <div className="max-w-5xl mx-auto text-center">
        <h2 className="text-4xl md:text-5xl font-bold mb-6 text-balance text-white">Ready to Wake Up Refreshed?</h2>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          onClick={() => { window.location.href = "tel:+17806651500" }}
            size="lg"
            className="bg-white text-primary border border-white hover:bg-white/90 hover:text-primary transition-colors"
          >
        ...
        <p className="text-sm text-white/90 mt-8 flex items-center justify-center gap-2">
